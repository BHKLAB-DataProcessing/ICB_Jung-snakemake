...
rule download_data:
    ...
    shell:
        ...
        wget -O {prefix}download/all_thresholded.by_genes.txt.gz {data_source}gistic/all_thresholded.by_genes.txt.gz
        wget -O {prefix}download/Jung_kallisto.zip https://github.com/BHKLAB-Pachyderm/ICB_Jung-data/raw/main/Jung_kallisto.zip
        """ 